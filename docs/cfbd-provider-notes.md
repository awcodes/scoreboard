...
- **Cancelled or postponed games** have no explicit status. A game still incomplete 12 hours after kickoff goes back to "upcoming". A rescheduled game follows its new `startDate`.
